    ...
    def grid(query,
        ...
        if rows:
            ...
            for row in rows:
                ...
                if selectable:
                    if selected:
                        #print request.vars.ecu_id_list
                        #print request.vars
                        #for ecu in request.vars.ecu_id_list:
                        #    trcols.append(
                        #    INPUT(_type="checkbox", _name="records", _value='on',
                        #         value=request.vars.records))
                        trcols.append(
                            INPUT(_type="checkbox", _name="records", _value=id,
                                 value=request.vars.records, checked='checked'))
                    else:
                        trcols.append(
                            INPUT(_type="checkbox", _name="records", _value=id,
                                  value=request.vars.records))
