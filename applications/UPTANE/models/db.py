...
db.define_table('vehicle_db',
                ...
                db.Field('supplier_version', 'string', required=True, writable=False, default='', readable=False),
                db.Field('director_version', 'string', required=True, writable=False, default='', readable=False),# requires=IS_NOT_EMPTY()),
                ...
                db.Field('vehicle_version', 'string', length=25, required=True, readable=True, writable=False, default='', requires=IS_NOT_EMPTY()),
